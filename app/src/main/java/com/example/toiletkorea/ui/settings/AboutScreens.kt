...
fun AboutPage(modifier: Modifier = Modifier,
        ...
        verticalArrangement = Arrangement.Top)
    {
        ...
        SettingOption(modifier = Modifier, icon = R.drawable.privacy ,
            text = R.string.privacy_policy_text, action = {navController.navigate(ToiletScreen.privacy.name)})
        Spacer(modifier.size(15.dp))
        SettingOption(modifier = Modifier, icon = R.drawable.terms_conditions,
            text = R.string.terms_and_conditions_text, action = {navController.navigate(ToiletScreen.terms.name)})
//        Spacer(modifier.size(15.dp))
...
fun TermsConditions(modifier: Modifier = Modifier){
    Column(modifier = Modifier
        ...
        Text(text = stringResource(id = R.string.terms_conditions), style = MaterialTheme.typography.bodySmall)
    }
}
...
fun PrivacyPolicy(modifier: Modifier = Modifier){
    Column(modifier = Modifier
        ...
        Spacer(modifier = modifier.size(20.dp))
        Text(text = stringResource(id = R.string.privacy_policy), style = MaterialTheme.typography.bodySmall)
    }
}
